<template>
  ...
  <div class="setting-box">
    ...
    <el-drawer v-model="setting" title="setting" :with-header="false" :size="isVscode ? 460 : 420">
      <el-form :model="theme" label-width="auto" style="max-width: 100%" class="theme">
        ...
        <el-form-item label="Flow">
          <el-radio-group v-model="flow" size="small" style="flex-wrap: nowrap">
            ...
            <el-radio-button value="scrolled-doc" border> Scrolled </el-radio-button>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item label="Font">
          <el-select v-model="theme.font" class="font-select" width="50" size="small">
            <el-option v-for="{ label, value } in fontFamily" :key="value" :label="label" :value="value">
        ...
        <el-form-item label="Speed">
          <el-select class="font-select" width="50" size="small" v-model="speed">
            <el-option v-for="(item, index) in speedList" :key="index" :label="item" :value="item"> </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="Voice">
          <el-select class="font-select" width="50" size="small" v-model="voiceIndex">
            <el-option v-for="(item, index) in voices" :key="item.name" :label="item.name" :value="index"> </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="Process Display">
          <el-select class="font-select" width="50" size="small" v-model="progressDisplayValue">
    ...
    <el-drawer v-model="info" title="search" :with-header="false" :size="400">
      <div v-if="information" class="information" :style="{ backgroundColor: information.color }">
